...
function main
{
    ...
    # Script variables
    env_url="https://github.com/CardiffUniversityComputationalRobotics/tue-env.git"
    { [[ -n "${targets_repo}" ]] && env_targets_url="${targets_repo}"; } || env_targets_url="https://github.com/CardiffUniversityComputationalRobotics/tue-env-targets.git"
